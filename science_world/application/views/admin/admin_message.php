	<h2 class="ico_mug">Dashboard</h2>
		...
		<table id="table">
			...
			<tr>
				...
				<td><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accepted"/></a><a href="#"><img src="<?php echo base_url();?>admin_img/cancel.jpg" alt="cancel"/></a><a href="#"><img src="<?php echo base_url();?>admin_img/folder.jpg" alt="folder"/></a><a href="#"><img src="<?php echo base_url();?>admin_img/edit.jpg" alt="edit"/></a></td>
		...
		<div id="panels" class="clearfix">
			<div class="panel photo left">
				...
				<ul class="clearfix">
					<li><img src="photos/1.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="photos/2.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="photos/3.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="photos/2.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="photos/1.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="photos/2.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
					<li><img src="photos/1.jpg" alt="photo"/><span><a href="#"><img src="<?php echo base_url();?>admin_img/accept.jpg" alt="accept"/></a><a href="#"><img src="img/cancel.jpg"  alt="deny"/></a></span></li>
