<form name="edit_blog" action="<?php echo base_url()?>blogger/update_blog" method="post" onsubmit="return validateStandard(this)">
    <h2 align="center"> <u>Edit Blog</u></h2>  
    <table border="0" align="center" width="90%">
        <tr> 
            <td>Blog Title:</td>
            <td>
                <input type="text" name="blog_title" value="<?php echo $result->blog_title;?>" placeholder="Blog Title" tabindex="1" maxlength="25" required="0"  err="Enter Your blog title" size="40" /><span class="required"> * </span>
