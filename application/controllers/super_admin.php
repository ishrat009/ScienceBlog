...
class Super_Admin extends CI_Controller {
    ...
    public function save_category() {
         ...
         * created date: 7 Aug 2013
	 * parameter: null
         * This fucntion redirects to admin_login function.
	 */
...
//        $this->session->set_userdata($sdata);
	 ...
	 * parameter: $category_id
         ...
         * This fucntion $category_id as a value.
	 */
    ...
    public function edit_category($category_id) {
         ...
         * created date: 7 Aug 2013
	 * parameter: null
         * This fucntion returns $data and $category_id.
	 */
    ...
    public function show_all_comments() {
         ...
         * author name: Shamvil
         * created date: 7 Aug 2013
	 * parameter: $comments_id
         * $comments_id is a variable containing unique id no of a single comment.
         * This fucntion returns $data as a value.
	 */
...
//        exit();
	 ...
	 * parameter: $comments_id
         * $comments_id is a variable containing unique id no of a single comment.
         * This fucntion returns $data and $comments_id.
	 */
	 ...
	 * parameter: $comments_id
         * $comments_id is a variable containing unique id no of a single comment.
         * This fucntion returns $comments_id.
	 */
    ...
    public function view_blogs() {
         ...
         * created date: 7 Aug 2013
	 * parameter: $blog_id
         * $blog_id is a variable containing unique id no of a single comment.
         * This fucntion returns $blog_id as a value.
	 */
...
//            print_r($udata);
    ...
    public function edit_event($event_id) {
         ...
         * created date: 7 Aug 2013
	 * parameter: null
         * This fucntion returns $data and $event_id.
	 */
...
//            print_r($udata);
	 ...
	 * parameter: event_id
         * $event_id is a variable containing unique id no of a single event.
         * This fucntion returns $event_id as a value.
	 */
